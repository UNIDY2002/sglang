...
# ---------------------------------------------------------------------------
# Post-process passes (normalization stage). This is a registry, not an
# execution order: each pass runs from its own slot via run_post_process_pass,
# and the slots span two stages -- _hisparse_validation is registered here but
# runs last, from check_server_args.
# ---------------------------------------------------------------------------
